...
const memoPosts = [
    {
        id: "post-20260916",
        date: "2026.09.16",
        text: "外部ツールを使っていつの記事に♡を何回押してくださったかがわかる。ぽちっとしてくださってうれしいです。",
        moreText: "追記機能も使っておこう。<br>またしてもSNSを整頓したい欲が出てきた。Xは自分の中での最適な距離感をつかめつつあるので、夢以外用の支部とブルスカを消すかもしれない。どうしても最適化をし続けたい性分の為、不要と判断したものは保留にしておけない。ミニマルな人間なのである。",
    },
    {
        id: "post-20260915",
        date: "2026.09.15",
