...
const memoPosts = [
    {
        ...
        moreText: "追記機能も使っておこう。<br>とはいえ、あまりここを見てくださってる方はいらっしゃらないとも思うので今の素直なぼやきを。<br>
            またしてもSNSを整頓したい欲が出てきた。Xは自分の中での最適な距離感をつかめつつあるので、整頓するのであれば夢以外用の支部とブルスカを消すかもしれない。
            どうしてもその時々の最適化をし続けたい性分の為、不要と判断したものは保留にしておけない。ミニマルな人間なのである。",
    },
    {
        id: "post-20260915",
        date: "2026.09.15",
